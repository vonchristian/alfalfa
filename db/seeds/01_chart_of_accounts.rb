...
Plutus::Asset.create(:name => "Cost and Profits in Excess of Billings")
Plutus::Asset.create(:name => "Notes Receivable")
Plutus::Asset.create(:name => "Prepaid Expenses")
Plutus::Asset.create(:name => "Other Current Assets")
...
Plutus::Asset.create(:name => "Less Acc. Depreciation", contra: true)
Plutus::Asset.create(:name => "Capital Leases")
Plutus::Asset.create(:name => "Other Assets")
...
Plutus::Liability.create(:name => "Notes Payable")
...
Plutus::Revenue.create(:name => "Materials")
Plutus::Revenue.create(:name => "Labor")
Plutus::Revenue.create(:name => "Subcontract")
Plutus::Revenue.create(:name => "Equipment")
Plutus::Revenue.create(:name => "Other")
...
Plutus::Expense.create(:name => " Car and Truck Expenses")
Plutus::Expense.create(:name => "Computer and Office Furniture")
Plutus::Expense.create(:name => "Repairs and Maintenance")
Plutus::Expense.create(:name => "Depreciation")
Plutus::Expense.create(:name => "Employee Wages and Salaries")
...
Plutus::Revenue.create(:name => "Other Income")
