...
Asset.create(code: 122, :name => "Cash Advances")
...
Revenue.create(code: 610, name: "Materials")
Revenue.create(code: 620, :name => "Labor" )
Revenue.create(code: 630, :name => "Subcontract" )
Revenue.create(code: 640, :name => "Equipment" )
Revenue.create(code: 650, :name => "Other" )
